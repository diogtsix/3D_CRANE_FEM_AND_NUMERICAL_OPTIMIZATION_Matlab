...
nexttile
stressesX = obj.solver.stressMatrix;

visualizeCrane(obj.solver.preprocessor,"displacedCoord", "s_{x} Axial-Stresses", stressesX)

fig.Children.Title.String = 'Axial Stresses for Truss Elements';
